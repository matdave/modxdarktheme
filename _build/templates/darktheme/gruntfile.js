...
module.exports = function(grunt) {
	...
	grunt.initConfig({
        ...
        dirs: {
            ...
            lib: 'node_modules/',
            scss: 'sass/',
            css: '../../../manager/templates/darktheme/css/',
            template: '../../../manager/templates/darktheme/',
            manager: '../../../manager/',
            root: '../../../'
        },
		copy: { /* move files */
        ...
        imageoptim: {
          png: {
            ...
            src: [
              ...
              '<%= dirs.root %>manager/templates/darktheme/**/*.png'
            ]
          },
          jpg: {
            options: {
            ...
            src: [
              ...
              '<%= dirs.root %>manager/templates/darktheme/**/*.jpg'
            ]
          },
          gif: {
            options: {
            ...
            src: [
              ...
              '<%= dirs.root %>manager/templates/darktheme/**/*.gif'
            ]
          }
        },
		uglify: {
